...
CREATE TABLE `ordemservico` (
  ...
  CONSTRAINT `ordemservico_ibfk_1` FOREIGN KEY (`fk_Cliente_id`) REFERENCES `cliente` (`id`),
  CONSTRAINT `ordemservico_ibfk_2` FOREIGN KEY (`fk_Funcionario_id`) REFERENCES `funcionario` (`id`)
